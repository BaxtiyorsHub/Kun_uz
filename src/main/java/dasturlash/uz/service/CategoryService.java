...
public class CategoryService {
    ...
    public CategoryEntity get(Integer id) {
        return repository.findById(id).orElseThrow(() -> new AppBadException("Item not found"));
    }

    public List<CategoryDTO> parseCategoryList(String categoryList) {
        try {
            return objectMapper.readValue(categoryList, new TypeReference<>() {});
        } catch (Exception e) {
