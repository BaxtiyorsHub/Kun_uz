...
public class ProfileService {
    ...
    public ProfileEntity get(Integer id) {
        return profileRepository.findByIdAndVisibleIsTrue(id)
                .orElseThrow(() -> new AppBadException("Profile not found"));
    }

    public ProfileDTO openDTO(Integer profileId) {
        ...
        dto.setPhoto(attachService.openDTO(profileEntity.getPhotoId()));
        return dto;
    }
}
